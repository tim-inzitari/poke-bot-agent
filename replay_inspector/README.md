  ...
  "records": [
    {
      ...
      "status": "verified",
      "checkpoint": {
        "path": "/srv/poke-bot-agent/archive/submission-bundles/55300000/extracted/model.pt",
        "sha256": "sha256:<64-lowercase-hex>"
      },
      "bundle": {
        "path": "/srv/poke-bot-agent/archive/submission-bundles/55300000/submission.tar.gz",
        "sha256": "sha256:<64-lowercase-hex>"
      },
      "matchup_tree": {
        "path": "/srv/poke-bot-agent/archive/submission-bundles/55300000/extracted/matchup_tree.json",
        "sha256": "sha256:<64-lowercase-hex>"
      },
      "runtime_package": {
        "path": "/srv/poke-bot-agent/archive/submission-bundles/55300000/submission.tar.gz",
      ...
      "runtime_parity_receipt": {
        "path": "/srv/poke-bot-agent/archive/submission-bundles/55300000/runtime-parity.json",
        "sha256": "sha256:<64-lowercase-hex>"
      },
      "replay": {
        "games": [
...
- source: `/srv/poke-bot-agent/replay-model-inspector-r176`;
- replay cache: `/srv/poke-bot-agent/archive/submission-replays`;
- inspector artifact root:
  `/srv/poke-bot-agent/archive/replay-model-inspector`;
- exact extracted submitted runtime:
  `/srv/poke-bot-agent/archive/replay-model-inspector/artifacts/runtimes/sha256-335d91c0f3f239d885c153a154531c0a43f33a9199e63a285be15deed55c0c5b/package`;
- container config:
  [`ops/elmo/replay-model-inspector-config-r176.json`](../ops/elmo/replay-model-inspector-config-r176.json);
