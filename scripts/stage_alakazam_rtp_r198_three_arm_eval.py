...
DEFAULT_CANDIDATE_ROOT = Path(
    "/home/pokebot/poke-bot-agent/outputs/rtp_fleet/alakazam-r197-shadow/candidates/"
    + R198_CANDIDATE_ID
)
DEFAULT_CANDIDATE_SOURCE_SNAPSHOT_ROOT = Path(
    "/home/pokebot/poke-bot-agent-deployments/alakazam-rtp-r197-src-2ae56bc6a2db"
)
DEFAULT_OUTPUT_ROOT = Path(
    "/home/pokebot/poke-bot-agent/outputs/rtp_fleet/alakazam-r198-three-arm-eval-attempt10"
)
DEFAULT_PAIRING_CAPABILITY = Path(
    "/home/pokebot/poke-bot-agent/.private/rtp-pairing-v2-probes-canonical-seal-v2/"
