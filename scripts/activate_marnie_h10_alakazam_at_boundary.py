...
STAGED_SCRIPT = Path(
    "/home/pokebot/poke-bot-agent/outputs/staging/"
...
def _register_runtime() -> None:
    ...
    command = [
        ...
        str(ACTIVE_SCRIPT),
        "--bootstrap-ready",
        "/home/pokebot/poke-bot-agent/outputs/state/final-format-marnie-r104-h10-bootstrap-ready.json",
        "--bootstrap-family",
        "/home/pokebot/poke-bot-agent/outputs/pure_rl/_protected/models/final-format-marnie-r104-h10-expert-bootstrap-v1",
        "--deployment-root",
        str(DEPLOYMENT),
        "--template-registry",
        "/home/pokebot/poke-bot-agent/outputs/final_format_alakazam_r79/runtime/specialist_runtime_registry_h10_r104_fusion_v3_directional_iter20_exact.json",
        "--guide",
        str(DEPLOYMENT / "config/deck_guides/marnie-s-grimmsnarl-ex.yaml"),
        "--expert-manifest",
        "/home/pokebot/poke-bot-agent/data/bootstrap/expert-latest20-2026-07-04-2026-07-23-roster18-v6-strategic/marnie-s-grimmsnarl-ex/PROTECTED_EXPERT_CORPUS.json",
        "--matchup-tree",
        ...
        "--selector-env",
        "/home/pokebot/poke-bot-agent/outputs/final_format_marnie_r104/runtime/specialist_runtime_h10_r104.env",
        "--receipt",
        "/home/pokebot/poke-bot-agent/outputs/state/final-format-marnie-r104-h10-runtime-registration.json",
        "--router-v6-family",
        "/home/pokebot/poke-bot-agent/outputs/pure_rl/_protected/models/final-format-marnie-r104-h10-router-v6-bootstrap-v1",
        "--router-v6-registry",
        str(DEPLOYMENT / "state/matchup_adapter_roster.json"),
        "--router-v6-receipt",
        "/home/pokebot/poke-bot-agent/outputs/state/final-format-marnie-r104-h10-router-v6-migration.json",
    ]
    result = _run(*command)
