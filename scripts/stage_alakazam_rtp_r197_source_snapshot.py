...
STAGE_COMMON_ARGUMENTS = (
    ...
    "cuda:0",
    "--raw-archive-root",
    "/home/inzi/poke-bot-agent/data/episodes/raw",
    "--max-train-games",
    "512",
    "--max-heldout-games",
    "128",
...
TEMPLATE_UNIT_LINES = frozenset(
    {
        ...
        (
            "ConditionPathExists=/home/inzi/poke-bot-agent/outputs/pure_rl/"
            "alakazam_terminal_expert_bootstrap_no_rtp_r195/checkpoints/"
            "expert_before_iter_00021.pt"
        ),
        (
            "ConditionPathExists=/home/inzi/poke-bot-agent/data/bootstrap/"
            "expert-alakazam-last5-2026-08-01-2026-08-05-r175/alakazam/"
            "PROTECTED_EXPERT_CORPUS.json"
        ),
        *(
            "ConditionPathExists=/home/inzi/poke-bot-agent/data/episodes/raw/"
