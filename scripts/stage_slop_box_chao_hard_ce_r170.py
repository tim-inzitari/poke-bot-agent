...
def unit_text(
    *,
    ...
    run_dir = "/home/inzi/poke-bot-agent/outputs/bootstrap/final_format_slop_box_chao_hard_r170"
    ready = "/home/inzi/poke-bot-agent/outputs/state/final-format-slop-box-chao-hard-ce-ready-r170.json"
    deep_state = (
...
ExecStart={py} -u /home/inzi/poke-bot-agent/scripts/run_slop_box_chao_hard_ce_r170.py \\
  --expert {expert} \\
...
MemoryMax=112G
MemorySwapMax=0
StandardOutput=append:/home/inzi/poke-bot-agent/outputs/final_format_slop_box_chao_hard_r170/logs/chao_hard.log
StandardError=append:/home/inzi/poke-bot-agent/outputs/final_format_slop_box_chao_hard_r170/logs/chao_hard.log
