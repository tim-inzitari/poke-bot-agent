...
DST = Path("/home/inzi/poke-bot-agent/data/bootstrap/expert-slop-box-teal-mask-full41-r170/teal-mask-ogerpon-ex")
...
def main() -> int:
    ...
    out = Path("/home/inzi/poke-bot-agent/outputs/state/slop-box-expanded-corpus-promoted-r170.json")
