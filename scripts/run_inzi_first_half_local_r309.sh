...
manifest=/home/inzi/alakazam-r309-work/raw_expert_corpus_manifest.json
work=/home/inzi/alakazam-r309-work
raw=$work/raw-first-half
mkdir -p "$raw"

python3 - "$manifest" <<'PY' | xargs -d '\n' -P8 -I{} cp -p "{}" /home/inzi/alakazam-r309-work/raw-first-half/
import json, sys
...
cd /home/inzi/alakazam-fast-split-r309
