...
def _materialize_contract(
    *, template_path: Path, registry_path: Path, pointer_path: Path, output: Path
    ...
    core.update(
        {
            "version": generation,
            "family": f"/home/inzi/poke-bot-agent/outputs/pure_rl/_protected/models/{stem.replace('-', '_')}",
            "initialization": {
            ...
            "run_dir": f"/home/inzi/poke-bot-agent/outputs/bootstrap/{stem}",
            "cpu_pack_root": f"/home/inzi/poke-bot-agent/outputs/bootstrap/cpu-packs/{stem}",
            "refresh_attempt": 1,
            "split_seed": 20260801,
        }
    )
    ...
    with lock_path.open("a+", encoding="utf-8") as lock:
        ...
        if receipt_path.is_file():
            ...
            runtime = {
                ...
                "registry_root": "/home/inzi/poke-bot-agent/outputs/pure_rl/_protected/models",
            }
