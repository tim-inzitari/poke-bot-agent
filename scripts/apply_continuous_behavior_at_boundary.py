...
def rollback_unit(stable_text: str) -> str:
    old = "/home/pokebot/poke-bot-agent-deployments/pure-rl-resident-v4"
    fallback = "/home/pokebot/poke-bot-agent-deployments/pure-rl-resident-v2"
...
def validate_staged_unit(text: str, staged_root: Path) -> None:
    required = (
        "WorkingDirectory=/home/pokebot/poke-bot-agent-deployments/pure-rl-resident-v4",
        "--resume auto",
