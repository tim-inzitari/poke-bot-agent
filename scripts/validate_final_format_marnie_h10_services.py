...
def main() -> int:
    ...
    cg_lib_path = Path("/home/inzi/poke-bot-agent/kaggle/input/cg-lib").resolve()
    ...
    required_core_refresh = (
        "ConditionPathExists=/home/inzi/poke-bot-agent/outputs/state/final-format-alakazam-r79-h10-completion-v1.json",
        "ConditionPathExists=/home/inzi/poke-bot-agent/outputs/state/final-format-marnie-r79-prestage-r104-h10-19.json",
    ...
    required_materialize = (
        "ConditionPathExists=/home/inzi/poke-bot-agent/outputs/state/final-format-marnie-r79-prestage-r104-h10-19.json",
        "ConditionPathExists=/home/inzi/poke-bot-agent/outputs/state/post-alakazam-core-refresh-boundary-r104.json",
        "OnSuccess=pokebot-final-format-marnie-r104-h10-bootstrap.service",
        "Environment=CG_LIB_PATH=/home/inzi/poke-bot-agent/kaggle/input/pokemon-tcg-ai-battle/sample_submission/sample_submission/cg",
        "materialize_final_format_marnie_h10.py",
    )
    required_bootstrap = (
        "ConditionPathExists=/home/inzi/poke-bot-agent/outputs/state/final-format-marnie-r104-h10-materialization.json",
        "Environment=CG_LIB_PATH=/home/inzi/poke-bot-agent/kaggle/input/pokemon-tcg-ai-battle/sample_submission/sample_submission/cg",
    ...
    required_register = (
        "ConditionPathExists=/home/inzi/poke-bot-agent/outputs/state/final-format-marnie-r104-h10-bootstrap-ready.json",
    ...
    required_rl = (
        "ConditionPathExists=/home/inzi/poke-bot-agent/outputs/state/final-format-marnie-r104-h10-runtime-registration.json",
        ...
        "Environment=POKEBOT_MATCHUP_ADAPTER_REGISTRY_PATH=/home/inzi/poke-bot-agent-deployments/final-format-marnie-h10-r104/state/matchup_adapter_roster.json",
        ...
        "Environment=POKEBOT_BERT_REMOTE_ROOT=/Users/tsinzitari/workspace/poke-bot-agent-h10-r79-stage",
        "EnvironmentFile=/home/inzi/poke-bot-agent-deployments/final-format-marnie-h10-r104/config/final_format_marnie_h10_runtime.env",
        "ExecStartPre=/usr/bin/test -s /home/inzi/poke-bot-agent-deployments/final-format-marnie-h10-r104/baselines/manifest.json",
        "ExecStartPre=/usr/bin/test -d /home/inzi/poke-bot-agent-deployments/final-format-marnie-h10-r104/decks",
        "ExecStartPre=/usr/bin/test -d /home/inzi/poke-bot-agent-deployments/final-format-marnie-h10-r104/kaggle",
        "register_final_format_marnie_h10_rl.py",
    ...
    required_gate_handler = (
        "EnvironmentFile=/home/inzi/poke-bot-agent/outputs/final_format_marnie_r104/runtime/specialist_runtime_h10_r104.env",
        "launch_active_specialist_gate_handler.py",
    ...
    required_completion = (
        "ConditionPathExists=/home/inzi/poke-bot-agent/outputs/state/final-format-marnie-r104-h10-passed-gate-handler-v1.json",
        "complete_final_format_marnie_refresh.py --check",
    ...
    required_capacity_boundary = (
        ...
        "--crustle-completion /home/inzi/poke-bot-agent/outputs/state/final-format-crustle-r113-h10-completion-v1.json",
    ...
    required_population_handoff = (
        "ConditionPathExists=/home/inzi/poke-bot-agent/outputs/state/post_refresh_sequence_complete_for_capacity_v2.json",
