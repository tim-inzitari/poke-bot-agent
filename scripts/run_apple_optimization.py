...
PYTHON = Path(
    os.environ.get(
        ...
        "/Users/example/workspace/poke-bot-agent-deployments/"
...
CHECKPOINT = Path(
    os.environ.get(
        ...
        "/Users/example/workspace/poke-bot-agent/outputs/pure_rl/"
        "pure_rl_core_exact20k_resident_v1_20260719/checkpoints/iter_00001.pt",
    )
)
CG_LIB = Path(
    "/Users/example/workspace/poke-bot-agent/kaggle/input/"
    "pokemon-tcg-ai-battle/sample_submission/sample_submission"
)
DECKS = (
    Path("/Users/example/workspace/poke-bot-agent/baselines/decks/ryota-alakazam-best5/deck.csv"),
    Path("/Users/example/workspace/poke-bot-agent/baselines/decks/kokinn-lucario-search-915/deck.csv"),
)
STATUS = Path(
    os.environ.get(
...
STATUS_MIRROR = Path(
    os.environ.get(
        ...
        "/Users/example/pokebot-dashboard/v1/m4_optimization_status.json",
    )
)
