...
DEFAULT_MILESTONE = Path(
    "/home/pokebot/poke-bot-agent/outputs/state/crustle-iter4-kaggle-milestone-r167.json"
)
DEFAULT_COMMIT = Path(
...
def _remote_install(local_package: Path, content_digest: str) -> list[dict[str, Any]]:
    ...
    targets = [
        (
            "bert",
            "/Users/example/workspace/poke-bot-agent/baselines/specialists/"
            + BASELINE_DIR,
        ),
        (
            "bert",
            "/Users/example/workspace/poke-bot-agent-h10-r79-stage/baselines/"
            "specialists/"
            + BASELINE_DIR,
        ),
        (
        ...
        (
            "elmo",
            f"/srv/poke-bot-agent/baselines/specialists/{BASELINE_DIR}",
        ),
    ]
...
def main() -> int:
    ...
    local_installs = [
        _install_package_copy(
            package,
            Path("/home/pokebot/poke-bot-agent/baselines/specialists") / BASELINE_DIR,
            content_digest,
        ),
        _install_package_copy(
            package,
            Path(
                "/home/pokebot/poke-bot-agent-deployments/pure-rl-resident-v9/"
    ...
    for manifest in (
        ...
        Path("/home/pokebot/poke-bot-agent/baselines/manifest.json"),
        Path(
            "/home/pokebot/poke-bot-agent-deployments/pure-rl-resident-v9/"
