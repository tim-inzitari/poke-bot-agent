...
def main() -> None:
    ...
    parser.add_argument("--root", type=Path, default=Path("/home/pokebot/poke-bot-agent"))
    parser.add_argument("--service", default="pokebot-pure-rl-alakazam.service")
    parser.add_argument("--poll-seconds", type=float, default=1.0)
    parser.add_argument(
        "--status",
        type=Path,
        default=Path("/home/pokebot/poke-bot-agent/outputs/state/public_mix_live_wr.json"),
    )
