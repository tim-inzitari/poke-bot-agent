...
ROOT=/home/pokebot/poke-bot-agent-deployments/pure-rl-resident-v31-matchup-runtime
PY=/home/pokebot/miniconda3/envs/poke-bot-agent/bin/python
RUN=/home/pokebot/poke-bot-agent/outputs/pure_rl/pure_rl_alakazam_temporal1_8k_teacher_v16_20260721
PARENT="$RUN/checkpoints/iter_00026.pt"
AUTH=/home/pokebot/poke-bot-agent/outputs/state/alakazam-matchup-adapter-iter26-v31-authorization.json
FIT=/home/pokebot/poke-bot-agent/outputs/matchup_adapters/alakazam-iter26-all22-v31/final.pt
MERGED="$RUN/checkpoints/iter_00026_matchup_v31.pt"
TREE_SOURCE=/home/pokebot/poke-bot-agent/outputs/state/public-matchup-tree-calibrated-v31.json
TREE_RUNTIME=/home/pokebot/poke-bot-agent/outputs/state/public-matchup-tree-runtime-v31.json
BOUNDARY_RECEIPT=/home/pokebot/poke-bot-agent/outputs/state/alakazam-matchup-runtime-iter26-v31.json
REMOTE_MARKER=/home/pokebot/poke-bot-agent/outputs/state/matchup-runtime-activation-v31.json
PRODUCTION_READY=/home/pokebot/poke-bot-agent/outputs/state/matchup-runtime-v31-production-ready.json
STATUS=/home/pokebot/poke-bot-agent/outputs/state/matchup-runtime-v31-finalizer.json
LOG=/home/pokebot/poke-bot-agent/outputs/logs/matchup-runtime-v31-finalizer.log
...
DROPIN_TARGET=/home/pokebot/.config/systemd/user/pokebot-pure-rl-alakazam.service.d/zzzzzzzzzzzzzzzzzz-v31-matchup-runtime.conf
HANDOFF_PATCH=/home/pokebot/poke-bot-agent/outputs/state/matchup-runtime-v31-handoff-patch
...
ssh bert.local "set -e; domain=gui/\$(id -u); target=\$domain/com.pokebot.remote-worker-8766; launchctl print \"\$target\" >/dev/null; d=/Users/example/workspace/poke-bot-agent/outputs/checkpoints; cp -p \"\$d/public-matchup-tree-runtime-v31.json\" \"\$d/public-matchup-tree-runtime-v31.json.before-$stamp\" 2>/dev/null || true; cp -p \"\$d/matchup-runtime-activation.json\" \"\$d/matchup-runtime-activation.json.before-$stamp\" 2>/dev/null || true; install -m 0444 \"$bert_tree_tmp\" \"\$d/public-matchup-tree-runtime-v31.json\"; install -m 0444 \"$bert_marker_tmp\" \"\$d/matchup-runtime-activation.json\"; rm -f \"$bert_tree_tmp\" \"$bert_marker_tmp\"; nohup launchctl kickstart -k \"\$target\" >/dev/null 2>&1 </dev/null &"
...
for endpoint in ("elmo:8765","bert.local:8766"):
...
from pathlib import Path
runtime=Path("/home/pokebot/poke-bot-agent/outputs/pure_rl/pure_rl_alakazam_temporal1_8k_teacher_v16_20260721/iteration_runtime.json")
