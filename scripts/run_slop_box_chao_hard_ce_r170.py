...
DEEP_CE_RUN = Path(
    "/home/pokebot/poke-bot-agent/outputs/bootstrap/final_format_slop_box_h10_rtp"
)
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "/home/pokebot/poke-bot-agent/state/slop_box_h10_rtp_prestage_identity_r170.json"
        ),
    )
    parser.add_argument(
        "--guide",
    ...
    parser.add_argument(
        "--protocol",
        type=Path,
        default=Path("/home/pokebot/poke-bot-agent/config/rl_protocol.yaml"),
    )
    parser.add_argument(
        "--registry-root",
        type=Path,
        default=Path("/home/pokebot/poke-bot-agent/outputs/pure_rl/_protected/models"),
    )
    parser.add_argument(
        "--cpu-pack-root",
        type=Path,
    ...
    log_dir = Path(
        "/home/pokebot/poke-bot-agent/outputs/final_format_slop_box_chao_hard_r170/logs"
    )
    ...
    receipt = Path(
        "/home/pokebot/poke-bot-agent/outputs/state/slop-box-chao-hard-ce-run-r170.json"
    )
