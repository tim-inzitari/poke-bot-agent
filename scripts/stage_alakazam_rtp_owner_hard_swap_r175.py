...
DECK_CSV = Path(
    "/home/pokebot/poke-bot-agent/decks/archetype-samples/"
    "alakazam-owner-rtp-pilot-r175.csv"
)
GUIDE = Path(
    "/home/pokebot/poke-bot-agent/config/deck_guides/alakazam-final-refresh.yaml"
)
PROTOCOL = Path("/home/pokebot/poke-bot-agent/config/rl_protocol.yaml")
...
ARCHIVE_CANDIDATES = (
    ...
    Path("/srv/poke-bot-agent/archive/episode-days"),
    Path("/home/pokebot/poke-bot-agent/archive/episode-days"),
)

RUNTIME_ROOT = Path(
    "/home/pokebot/poke-bot-agent/outputs/final_format_alakazam_rtp_r175"
)
...
CONTRACT_PATH = Path(
    "/home/pokebot/poke-bot-agent/state/alakazam-rtp-owner-hard-swap-r175.json"
)
STATE_PATH = Path(
    "/home/pokebot/poke-bot-agent/outputs/state/"
...
PARENT_REGISTRY = Path(
    "/home/pokebot/poke-bot-agent/outputs/final_format_alakazam_r79/runtime/"
...
def write_contract(
    *,
    ...
    atomic_json(
        Path("/home/pokebot/poke-bot-agent/outputs/state/alakazam-rtp-owner-hard-swap-r175.json"),
        contract,
    )
    return contract
...
def run_bootstrap(*, python: Path, expert: Path) -> None:
    ...
    if not guide_ready.is_file():
        ...
        if alt.is_file():
            guide_ready = alt
    curriculum_dir = Path(
        "/home/pokebot/poke-bot-agent/state/final_format_alakazam_curriculum_r79"
    )
