...
INZI_ROOT = Path("/home/pokebot/poke-bot-agent/outputs/matchup_adapters/alakazam-iter26-fleet-v31")
BERT_ROOT = Path("/Users/example/workspace/poke-adapter-fleet-v31/output")
