...
DEFAULT_RAW_EPISODE_ROOT = "/mnt/Main/main/poke-bot-agent/archive/episode-days"
DEFAULT_SNAPSHOT_PARENT = (
    "/mnt/Main/main/poke-bot-agent/outputs/experiments/"
    "alakazam-prize-plan-v2-r23-source-snapshots"
)
DEFAULT_PRIVATE_STAGE_PARENT = "/mnt/Main/main/poke-bot-agent/outputs/experiments"
DEFAULT_TARGET_ROOT = (
    "/mnt/Main/main/poke-bot-agent/outputs/experiments/"
...
def _validate_remote_absolute(path: str, *, label: str) -> str:
    ...
    artifact_root = PurePosixPath("/mnt/Main/main/poke-bot-agent")
    try:
...
def bounded_absolute(value, label):
    path = PurePosixPath(value)
    root = PurePosixPath("/mnt/Main/main/poke-bot-agent")
...
def rename_no_replace(source, destination):
    ...
    publication_root = Path("/mnt/Main/main/poke-bot-agent/outputs/experiments")
    try:
