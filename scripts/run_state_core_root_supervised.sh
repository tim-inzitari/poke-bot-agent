...
readonly repo="/home/pokebot/poke-bot-agent-deployments/state-core-v1"
readonly python="/home/pokebot/miniconda3/envs/poke-bot-agent/bin/python"
readonly log_file="/home/pokebot/poke-bot-agent/outputs/logs/bootstrap.log"
readonly supervisor_log="/home/pokebot/poke-bot-agent/outputs/logs/bootstrap.supervisor.log"
readonly result_file="/home/pokebot/poke-bot-agent/outputs/train/state_core_top_ladder_5day_full_20260719_result.json"
child_pid=""
...
while [[ ! -f "$result_file" ]]; do
  ...
  (
    ...
    export HOME=/home/pokebot
    exec "$python" -u scripts/train_bootstrap.py \
      --jsonl /home/pokebot/poke-bot-agent/data/bootstrap/top_ladder_all_2026-07-03_to_2026-07-07.jsonl \
      ...
      --seed 20260725 \
      --resume auto \
      --init-checkpoint /home/pokebot/poke-bot-agent/outputs/checkpoints/state_core_top_ladder_5day_20260719.latest.pt \
      >> "$log_file" 2>&1
  ) &
  child_pid=$!
