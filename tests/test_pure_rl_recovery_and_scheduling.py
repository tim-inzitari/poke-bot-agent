...
def test_real_v15_effective_to_v17_contract_migration_is_fully_audited(
    ...
    v15_root = Path(
        "/home/pokebot/poke-bot-agent-deployments/pure-rl-resident-v15-strong-practice"
    )
    v17_root = Path(
        "/home/pokebot/poke-bot-agent-deployments/pure-rl-resident-v17-research-controls"
    )
    control_ids = (
        "iono",
        "dragapult-ex",
    ...
    stored = {
        ...
        "collection": {
            "auxiliary_targets": {
                "hidden_engine": {
                    "path": "/home/pokebot/poke-bot-agent/outputs/engines/libcg_hidden_inzi_v1.so",
                    "digest": "sha256:" + "c" * 64,
                    "size": 100,
                }
            },
