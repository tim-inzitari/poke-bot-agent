...
def test_managed_activation_unit_targets_only_rehearsal_boundary() -> None:
    ...
    assert (
        "--deployment-root /home/pokebot/poke-bot-agent-deployments/"
        "final-format-marnie-h10-r104"
        in unit
    )
    assert "--poll-seconds 0.1" in unit
    assert (
        "EnvironmentFile=/home/pokebot/poke-bot-agent/outputs/"
        "final_format_marnie_r104/runtime/specialist_runtime_h10_r104.env"
        in unit
    )
    assert (
        "EnvironmentFile=/home/pokebot/poke-bot-agent-deployments/"
    ...
    assert (
        ...
        "final-format-marnie-h10-r104:/home/pokebot/poke-bot-agent"
        in unit
    )
