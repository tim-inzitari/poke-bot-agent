...
def test_initial_remote_slot_connections_fan_out_concurrently(
    ...
    elmo = Template("elmo", 8765)
    bert = Template("bert", 8766)
...
def test_elmo_missing_smb_stages_new_digest_over_verified_ssh(
    ...
    assert (
        remote_jobs.resolve_remote_checkpoint_path("elmo", str(source))
        == remote_path
    )
...
def test_prepare_remote_play_job_stages_both_elmo_checkpoints(
    ...
    original = {
        "checkpoint": "/home/pokebot/poke-bot-agent/current.pt",
        "opponent_checkpoint": "/home/pokebot/poke-bot-agent/previous.pt",
    }

    prepared = prepare_remote_play_job("elmo", original)
    ...
    assert original["checkpoint"].startswith("/home/pokebot/")
    assert original["opponent_checkpoint"].startswith("/home/pokebot/")
...
def test_prepare_remote_play_job_remaps_both_bert_checkpoints(
    ...
    def _native(path: str) -> str:
        return path.replace(
            "/home/pokebot/poke-bot-agent",
            "/Users/example/workspace/poke-bot-agent",
        )
    ...
    original = {
        "checkpoint": "/home/pokebot/poke-bot-agent/current.pt",
        "opponent_checkpoint": "/home/pokebot/poke-bot-agent/previous.pt",
        "spec": {"path": "/home/pokebot/poke-bot-agent/baselines/agent.py"},
    }
    ...
    assert prepared["checkpoint"].startswith("/Users/example/workspace/")
    assert prepared["opponent_checkpoint"].startswith(
        "/Users/example/workspace/"
    )
    assert original["spec"]["path"].startswith("/home/pokebot/")
