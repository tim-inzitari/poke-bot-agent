...
def test_alakazam_specialist_unit_pins_volume_fleet_and_rehearsal_contract() -> None:
    ...
    assert (
        ...
        'elmo:8765=336,bert.local:8766=176"'
    ) in unit
    ...
    assert (
        "--initial-learner-checkpoint /home/pokebot/poke-bot-agent/outputs/"
...
def test_transition_watcher_is_exact_40_percent_or_patience_ten() -> None:
    ...
    assert (
        "--specialist-deployment-root /home/pokebot/poke-bot-agent-deployments/"
        "pure-rl-continuous-rehearsal-v1"
    ) in unit
    assert (
        "--handoff-ready /home/pokebot/poke-bot-agent/outputs/state/"
