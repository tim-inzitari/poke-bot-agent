...
def test_archaludon_import_is_inactive_and_checksum_authorized() -> None:
    ...
    assert (
        "ExecStartPost=/home/pokebot/miniconda3/envs/poke-bot-agent/bin/python "
        "/home/pokebot/poke-bot-agent/scripts/"
        "validate_future_specialist_strategic_curriculum.py" in unit
    )
    assert "--guide-ready-receipt /home/pokebot/poke-bot-agent/data/bootstrap/" in unit
    assert "--training-implementation /home/pokebot/poke-bot-agent/poke_bot/train.py" in unit
