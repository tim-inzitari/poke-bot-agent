...
def test_r175_boundary_stops_exactly_after_committed_iteration_20() -> None:
    ...
    assert "--run-dir /home/pokebot/poke-bot-agent/outputs/pure_rl/final_format_alakazam_rtp_r175_i_v6_8k" in text
...
def test_r175_boundary_successor_freezes_only_the_verified_terminal_checkpoint() -> None:
    ...
    assert "--boundary /home/pokebot/poke-bot-agent/outputs/state/final-format-alakazam-rtp-r175-iter20-boundary-r193.json" in text
    assert "--unit pokebot-final-format-alakazam-rtp-r175-rl.service" in text
