"""Orchestrate Slowking distill stages A→E under research-only authority."""
...
from .day_split import DaySplit, build_day_split, default_val_dates_for_window, write_split
