...
- **Iter4 collection sealed** under settrace fix with **zero** `public_mix_refill` (8192/365218, `baseline_failed=0`, `targeted_public_mix_retry_attempts=0`). Quarantine: `quarantine/iter_00004/attempt_0001/`. Live: learner/heldout for iter4 under MainPID `538332` / trainer `538484`. RTP MainPID `3025385` left alone. Keep Bert Alakazam rejoin poller bootout until a CPU/MPS selector exists.
