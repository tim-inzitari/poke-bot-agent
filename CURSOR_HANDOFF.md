...
- **Live after repair:** RL MainPID `212552` / trainer `212701` (NRestarts=2, started 2026-08-06 05:48:47 EDT) recollecting **iter3** `self_play` under the patched process. RTP co-train MainPID `3025385` (NRestarts=0) left alone. Keep Bert Alakazam rejoin poller bootout until a CPU/MPS selector exists.
