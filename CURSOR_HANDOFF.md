...
- **Live:** RL MainPID `538332` / trainer `538484` (restarted 2026-08-06 ~07:55 EDT after settrace fix) recollecting **iter4**; quarantine `quarantine/iter_00004/attempt_0001/`. RTP co-train MainPID `3025385` (NRestarts=0) left alone. Keep Bert Alakazam rejoin poller bootout until a CPU/MPS selector exists.
