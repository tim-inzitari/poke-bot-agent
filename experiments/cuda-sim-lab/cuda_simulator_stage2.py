...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path("/home/pokebot/cuda-sim-lab/outputs/official-rule-slice-cuda.json"),
    )
    parser.add_argument(
        "--official-fixtures-report",
        type=Path,
        default=Path("/home/pokebot/cuda-sim-lab/outputs/official-rule-slice-fixtures.json"),
    )
    parser.add_argument(
        "--official-end-turn-report",
        type=Path,
        default=Path("/home/pokebot/cuda-sim-lab/outputs/official-clean-end-turn-cuda.json"),
    )
